...
$total_mahasiswa_query = mysqli_query($conn, "SELECT COUNT(*) as total_mahasiswa FROM data_mahasiswa;");
$total_mahasiswa = 0;

while ($row_total_mahasiswa = $total_mahasiswa_query->fetch_assoc()) {
...
?>
<div class="alert alert-primary" role="alert"> Selamat Datang Di halaman Home </div>
<div class="row">
	<div class="col-lg-7">
		<div class="row">
			<div class="col-sm-6">
					...
					<div class="card-body">
						<div class="media align-items-center">
							...
							<div class="media-body">
								...
								<?php while ($row4 = $jml_jurusan->fetch_assoc()) {
		...
		<div class="row">
			<div class="col-12">
				<div class="table-responsive">
                    ...
                    // Display the data
                    foreach ($jurusanData as $row5) {
                    ?>
                        <tr>
                            <td><?php echo $row5['nama_jurusan']; ?></td>
                            <td><?php echo $row5['jumlah_mahasiswa']; ?></td>
                        </tr>
                    <?php
                    }
                    ?>
						...
						<div class="row d-flex">
							<div class="col-md-8">
								<h4 class="text-bold text-weight-bolder"
									...
									<img src="https://unibamadura.ac.id/page/images/profil/1.png" width="28" alt=""
								...
								<span class="mb-5"><?php
									...
									$currentDateAndDay = strftime('%A, %e %B %Y');

									echo $currentDateAndDay;
									?></span>
							</div>
							<div class="col-md-4">
