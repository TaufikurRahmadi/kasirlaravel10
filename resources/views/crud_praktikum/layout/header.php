	...
	***********************************-->
				...
				<nav class="navbar navbar-expand">
					<div class="collapse navbar-collapse justify-content-between">
						<div class="header-left">
							<div class="dashboard_bar" id="dashboardTitle">
								Dashboard
							</div>

							<!-- Konten Dashboard Bar akan diperbarui secara dinamis -->
						</div>
					</div>
	...
	<div class="deznav">
		<div class="deznav-scroll mm-active">
			...
			<div class="add-menu-sidebar">
				...
				<a href="../crud_praktikum/logout.php" class="font-w500 mb-0">Logout</a>
			</div>
			<div class="copyright">
	...
	<div class="content-body default-height">
		<div class="container-fluid">
			...
			<script src="otomatis.js" defer></script>