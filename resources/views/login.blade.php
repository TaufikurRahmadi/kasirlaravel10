...
if (isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM operator_sistem WHERE email_operator = '$email' AND password_operator = '$password'";
    $result = mysqli_query($conn, $query);
    if (mysqli_num_rows($result) > 0) {
        $operator = mysqli_fetch_assoc($result);
        $_SESSION['id_operator'] = $operator['id_operator'];
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form action="login.php" method="POST">
                                        ...
                                        <label for="email_operator" class="form-label">Email</label>
                                <input type="email" class="form-control" id="email_operator" name="email_operator"
                                                placeholder="hello@example.com">
                                        </div>
                                        <div class="mb-4 position-relative">
                                            <label for="password_operator" class="form-label">Password</label>
                                <input type="password" class="form-control" id="password_operator" name="password_operator"placeholder="1233123">
                                        ...
                                        if (isset($_POST["login"])) {
                                            $email = $_POST['email_operator'];
                                            $password = md5($_POST['password_operator']);
                                            ...
                                            if (mysqli_num_rows($cek) > 0 ){
                                                ...
                                                mysqli_query($conn,"UPDATE operator_sistem SET last_login = '$waktu_login' where id_operator = '$_GET[id_operator]'");
